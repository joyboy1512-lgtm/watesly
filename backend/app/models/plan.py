...
class Plan(UUIDPrimaryKeyMixin, TimestampMixin, Base):
    ...
    max_organizations: Mapped[int] = mapped_column(Integer, nullable=False, default=0)
    ...
    mac_limit_policy: Mapped[str] = mapped_column(String(20), nullable=False, default="soft")
    ...
    allow_multi_organization: Mapped[bool] = mapped_column(Boolean, nullable=False, default=True)
